...
preprocessData(['17'],AUDIO_DIR,CHORD_DIR,chord_dict,NOTES_DICT,chord_list,hop_length=hop_length,window_frames=19,postfix=postfix, octave_shift=octaves,usage="train")
